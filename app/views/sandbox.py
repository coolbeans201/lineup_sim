...
st.title("Sandbox")
st.caption("Build lineups freely or under team+decade spins — one pick revealed at a time.")
...
elif build_mode == BUILD_MODE_PICK and spin_draft:
    st.caption("Set team and decade for the current pick only — future picks stay hidden.")
